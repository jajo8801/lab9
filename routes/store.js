// This code snippet loads/includes the database module that we just 
// created in Part 5. We will be making use of this module to connect 
// to the database to run SQL queries below.
